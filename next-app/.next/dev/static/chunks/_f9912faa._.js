            ...
            async function fetchFiles() {
                try {
                    ...
                    const userFiles = data.filter({
                        "Dashboard.useEffect.fetchFiles.userFiles": (f)=>f.user === 'test@example.com'
                    }["Dashboard.useEffect.fetchFiles.userFiles"]);
                    setFiles(userFiles);
                } catch (err) {
...
_s(Dashboard, "J/jovxkPTVVBnL0aQDwglxwjdIk=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=_f9912faa._.js.map